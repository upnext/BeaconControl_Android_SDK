...
public class BeaconService extends Service implements BeaconConsumer {
    ...
    public static final String ACTION_NAME = "io.upnext.beaconcontrol.sdk.BeaconService.ACTION";
    ...
    private void processEvent(BeaconEvent beaconEvent, long eventTimestamp, Region region) {
        processEvent(beaconEvent, eventTimestamp, region, io.upnext.beaconcontrol.sdk.Beacon.DISTANCE_UNDEFINED);
    }
